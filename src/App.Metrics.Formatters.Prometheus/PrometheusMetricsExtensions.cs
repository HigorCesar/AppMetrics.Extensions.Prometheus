                                 ...
                                 summary = new Summary()
                                           {
                                               ...
                                               sample_sum = metric.Value.Histogram.Sum.ToSeconds(),
                                               quantile =
                                               {
                                                   new Quantile() { quantile = 0.5, value = metric.Value.Histogram.Mean.ToSeconds() },
                                                   new Quantile() { quantile = 0.75, value = metric.Value.Histogram.Percentile75.ToSeconds() },
                                                   new Quantile() { quantile = 0.95, value = metric.Value.Histogram.Percentile95.ToSeconds() },
                                                   // new Quantile(){quantile = 0.98, value = metric.Value.Histogram.Percentile98},
                                                   new Quantile() { quantile = 0.99, value = metric.Value.Histogram.Percentile99.ToSeconds() },
